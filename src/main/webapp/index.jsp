        ...
        <div class="iteam singin">
            ...
            <form action="register">
                <div class="names">
                    ...
                    <div class="form__group field">
                        <input type="text" class="form__field" placeholder="Age" name="age" id='age' required />
                ...
                <div class="info">
                    ...
                    <input type="input" class="form__field" placeholder="Name" name="address" id='name' required /> 
                ...
                <div class="form__group field">
                    ...
                    <input type="input" class="form__field" placeholder="Name" name="phone" id='name' required />
                ...
                <div class="form__group field">
                    ...
                    <input type="input" class="form__field" placeholder="Name" name="email" id='name' required />
